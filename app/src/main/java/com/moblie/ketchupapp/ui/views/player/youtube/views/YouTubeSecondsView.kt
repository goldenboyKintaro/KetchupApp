package com.moblie.ketchupapp.ui.views.player.youtube.views
 ...
 *
 * Used by [YouTubeOverlay][com.moblie.ketchupapp.ui.views.player.youtube.YouTubeOverlay].
 */
class SecondsView(context: Context, attrs: AttributeSet?) :
    ...
    @DrawableRes
    var icon: Int = R.drawable.play_solid
        set(value) {
            if (value > 0) {
